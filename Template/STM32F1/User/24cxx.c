...
#define  IIC_SDA		 	LL_GPIO_IsInputPinSet(GPIOA,LL_GPIO_PIN_11)
#define  IIC_SDA_H		LL_GPIO_SetOutputPin(GPIOA , LL_GPIO_PIN_11)
#define  IIC_SDA_L  	LL_GPIO_ResetOutputPin(GPIOA , LL_GPIO_PIN_11)          
#define  IIC_SCL_H 		LL_GPIO_SetOutputPin(GPIOA , LL_GPIO_PIN_12)
#define  IIC_SCL_L 		LL_GPIO_ResetOutputPin(GPIOA , LL_GPIO_PIN_12) 
